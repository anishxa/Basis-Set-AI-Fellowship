...
class BamlSyncClient:
    ...
    def AnalyzeArticle(self, headline: str,body: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="AnalyzeArticle", args={
...
class BamlStreamClient:
    ...
    def AnalyzeArticle(self, headline: str,body: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ArticleAnalysis, types.ArticleAnalysis]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="AnalyzeArticle", args={
            "headline": headline,"body": body,
        })
        return baml_py.BamlSyncStream[stream_types.ArticleAnalysis, types.ArticleAnalysis](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def AnalyzeArticle(self, headline: str,body: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="AnalyzeArticle", args={
            "headline": headline,"body": body,
        }, mode="request")
        return __result__
